...
extern err_t mp_ports_unmap_port(/*@temp@*/const j_t *root, /*@temp@*/const char *internal_port, /*@temp@*/const char *external_port, /*@temp@*/const char *protocol);
extern err_t test_if_port_mapped(int internal_port);
extern /*@null@*/ buf_t *mp_ports_get_external_ip(void);

extern /*@null@*/ /*@only@*/ j_t *mp_ports_if_mapped_json(/*@temp@*/const j_t *root, /*@temp@*/const char *internal_port, /*@temp@*/const char *local_host, /*@temp@*/const char *protocol);
