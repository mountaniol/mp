 ...
 * @brief Register new MODULE handlers in dispatcher
 * @param module_id module ID, from module_type_e list
 ...
 * @func int mp_disp_prepare_request(void *json, char
 *  	  target_host, module_type_e dest, module_type_e source,
 *  	  ticket_t ticket)
 ...
 * @param module_type_e "dest_module": module ID this message
 *  					 dedicated to
 * @param module_type_e "src_module": module ID of the module
 ...
 * @param target_host Target machine UID (source machine filled
 *  				  for this machin)
 * @param dest_module Target module ID
