...
extern /*@null@*/ char *mp_communicate_forum_topic(const char *user, const char *uid);
extern /*@null@*/ char *mp_communicate_forum_topic_all(const char *user);
extern /*@null@*/ char *mp_communicate_private_topic(const char *user, const char *uid);
extern /*@null@*/ char *mp_communicate_private_topic_all(const char *user);
